            ...
            <div class="content-wrapper">
                <div class="row d-flex justify-content-center">
                    <div class="col-md-6 grid-margin stretch-card">
                        <div class="card">
                            <div class="card-body">
                                <h4 class="card-title">Import donnees</h4>
                                <p class="card-description">
                                    Insertion
                                </p>
                                <form class="forms-sample" method="post" action="/devis/importDataCSV" enctype="multipart/form-data">
                                    <div class="form-group">
                                        <input type="file" name="maisonTravauxFile" class="file-upload-default">
                                        <div class="input-group col-xs-12">
                                            <input type="text" class="form-control file-upload-info"
                                                disabled placeholder="Maison travaux" />
                                    ...
                                    <div class="form-group">                                       
                                        <input type="file" name="devisFile" class="file-upload-default file-upload-default2">
                                        <div class="input-group col-xs-12">
                                            <input type="text" class="form-control file-upload-info"
                                                disabled placeholder="Devis" />
                                            <span class="input-group-append">
                                                <button class="file-upload-browse2 btn btn-primary"
                                                    type="button">
                                                    <i class="mdi mdi-paperclip" style="font-size: 0.9rem;"></i>
                                                </button>
                                            </span>
